...
\begin{itemize}
    ...
    \item \textbf{后端开发：}开发不局限于特定编程语言和技术栈。熟练掌握Golang/Java语言，熟悉C/C++语言，有充足Linux开发经验。熟悉微服务架构理念，掌握KiteX/Hertz等RPC/HTTP框架。熟悉MySQL和Redis，具备数据库设计与优化能力。熟悉服务监控与告警，熟悉常用设计模式，能够设计并实现高质量代码。
