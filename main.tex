...
\begin{itemize}
    ...
    \item \textbf{特卖钱效PSM-DID分析框架：}设计并实现特卖钱效PSM-DID分析框架，框架支持特卖营销业务（如夜市万人团、周末万人团、秒杀营销等玩法）的钱效分析。夜市万人团反转实验均呈现显著正向GMV增量，渗透用户的每日人均大盘GMV提升范围为4.54至4.83元，GMV-ROI在3.38至3.93之间，表明玩法策略对渗透用户群体有效。
\end{itemize}
